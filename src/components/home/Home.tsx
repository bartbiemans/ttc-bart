...
export const Home = () => {
    return (
        <div>
            ...
            <Row>
                <Col lg={7} sm={10}>
                    <Announcement title={'Kampioenschap Fort van Merksem 2024!'}
                                  body={'Dit jaar organiseert Sevos het kampioenschap van het fort van merksem. Meer info vind u hier: '}
                                  link={'../../beker.pdf'}
